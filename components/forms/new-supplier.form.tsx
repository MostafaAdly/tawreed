    ...
    return (
        <form action={formAction}>
            <div className="grid gap-6 mb-6 md:grid-cols-2 py-3">
                ...
                <InlineFormField id="phone" type='text' title="الهاتف" placeholder="01xxxxxx123" />
                <InlineFormField id="username" type='text' title="إسم المستخدم" placeholder="user.name123" />
            </div>
