                    ...
                    <div className="pb-4 bg-white dark:bg-gray-900">
                        ...
                        <div className="relative mt-1 grid">
                            <div className="flex flex-row gap-x-5">
                                <button onClick={clearFilter} type="button" className="h-[100%] focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 center focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900 text-nowrap">
    ...
    return (
        <tr className="odd:bg-white odd:dark:bg-gray-900 even:bg-slate-100 even:dark:bg-gray-800 border-b dark:border-gray-700">
            ...
            <td className="px-3 py-3 center flex-col gap-y-2">
                <OfferModal offer={order} buttonStyle='font-medium text-blue-600 dark:text-blue-500 hover:underline' />
