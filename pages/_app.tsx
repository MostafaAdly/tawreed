...
export default function MyApp({ Component, pageProps }: AppProps) {
  ...
  const description = `تُفتح لك بوابة المستقبل في عملية الشراء! انضم إلينا لتتمتع بتوطين عمليتك بواسطة منصتنا المُشغَّلة بالذكاء الاصطناعي. قم بتبسيط سير العمل، وتعزيز علاقاتك مع المورّدين، وتأمين عمليات الشراء في أقل من ساعتين. استمتع بتوفير التكاليف على الشحن والموظفين، بالإضافة إلى الوصول إلى عروض أفضل. خذ السيطرة، وقم باتخاذ قرارات أكثر ذكاءً بسرعة، واستمتع بتجربة مستقبلية في عمليات الشراء من خلال تجربة مجانية!`;
